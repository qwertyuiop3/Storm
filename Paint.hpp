			...
			if (Get_Bounds() == 1)
			{
				...
				auto Create_Font = [&]() -> void*
				{
					...
					Calculate_Character_Bounds_Label:
					{
						...
						Draw_Text_Type((unsigned __int32)Engine_Module + 2219008)(Font, 0, 0, 0, 0, 0, 0, Text);
				...
				Calculate_Text_Bounds_Label:
				{
					...
					Draw_Character_Label:
					{
						...
						if (Ghost == 0)
						{
							Draw_Text_Type((unsigned __int32)Engine_Module + 2219008)(Font, Bounds[1] + 7 + Offset_X - Character_Bounds[0], Bounds[2] + Offset_Y, Paint_Data->Color[0], Paint_Data->Color[1], Paint_Data->Color[2], 255, Text);
						}
						else
						{
							Draw_Text_Type((unsigned __int32)Engine_Module + 2219008)(Font, Bounds[1] + 7 + Offset_X - Character_Bounds[0], Bounds[2] + Offset_Y, 128, 128, 128, 255, Text);
						}
